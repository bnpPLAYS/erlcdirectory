      ...
      <div className="space-y-8 text-sm text-muted-foreground leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-1 mt-2">
            <li>
              <strong className="text-foreground">Discord OAuth:</strong> username, numeric Discord ID, avatar URL, and server list scope used for features such as listing verified servers. Sign-in uses Discord identify + guilds only; your Supabase auth record may use an internal address so the account can exist without sharing an email from Discord.
            </li>
            <li>
