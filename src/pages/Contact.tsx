  ...
  <div className="min-h-screen bg-background flex flex-col">
    ...
    <main className={`flex-1 container mx-auto px-4 py-16 max-w-lg text-center ${pageHeroEnter}`}>
      ...
      <p className="text-muted-foreground text-sm mb-8 leading-relaxed">
        Join the official Discord for community help, updates, and the fastest support. For sensitive issues (privacy,
        legal, or abuse) you can also email us.
      </p>
      <div className="flex flex-col gap-3">
        <a
          ...
          className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/15 bg-[#5865F2] px-6 py-4 text-sm font-medium text-white hover:bg-[#4752C4] transition-colors"
        >
          ...
          Join Discord — support & community
          <ExternalLink className="h-3.5 w-3.5 opacity-80" aria-hidden />
        </a>
        <a
          href="mailto:support@erlc.directory?subject=www.erlc.directory%20support"
