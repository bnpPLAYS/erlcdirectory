...
import { ArrowRight, Users, Shield, Star, Zap } from 'lucide-react';
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero — centered, staff-directory style */}
        ...
        <div className="container mx-auto px-4 relative">
          <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-5 tracking-tight leading-[1.05]">
              ER:LC Staff Directory
            </h1>
            <p className="text-base md:text-lg text-muted-foreground mb-4 max-w-xl">
              The professional network for Emergency Response: Liberty County staff and contributors.
            </p>
            <p className="text-sm text-muted-foreground/90 mb-10 max-w-md">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 flex items-center justify-center">
                <img src={logo} alt="" className="logo-mark w-6 h-6 object-contain" width={24} height={24} aria-hidden />
              </div>
